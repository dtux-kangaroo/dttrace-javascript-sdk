...
(function (global, factory) {
  ...
  var screen$1 = global.screen;
  var location$1 = global.location;
  ...
  function initialize () {
    ready$1(function (){
      ...
      addEventListener(global,'load',pageEnterHandler,false);
      addEventListener(global,'pageshow',pageEnterHandler,false);

    
      //代理所有className为dttrace的dom元素
      var element_body = document.getElementsByTagName('body')[0];
      addEventListener(element_body, 'click',function (arg_event){
        var final_event = global.event || arg_event;
      ...
      addEventListener(global,'beforeunload',pageLeaveHandler,false);
      addEventListener(global,'pagehide',pageLeaveHandler,false);
  ...
  var carryRocket = function (fun, params) {
    ...
    return function () {
      ...
      var final_event = global.event ? global.event : arg0;
